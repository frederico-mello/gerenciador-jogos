# Capability: school-directory

## Purpose

TBD — Diretório controlado de escolas de São José dos Campos, alimentado pelo Censo Escolar INEP, com CRUD mínimo para admin_sistema.
