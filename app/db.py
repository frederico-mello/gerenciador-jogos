...
def _apply_column_migrations(conn):
    """Aplica migrations idempotentes de ADD COLUMN nas tabelas users e loans.
    ...
    migrations = (
        ...
        "ALTER TABLE loans ADD COLUMN termos_aceite_at TEXT",
        "ALTER TABLE loans ADD COLUMN termos_versao TEXT",
    )
